...
class LocationRestrictionsShellSiteRestrictionsItems(object):

    """Implementation of the 'LocationRestrictionsShellSiteRestrictionsItems' model.
    ...
    Attributes:
        ...
        sites (List[str]): A list of Site IDs in this country, in the format
            ...
            4-digit site number in that country, which needs to be either
            restricted or allowed.  A list of values must be passed for either
            Sites or SiteGroups or both.  Max 10 sites are allowed for the
            Shell site Restriction.  For example, “GB1234”.
        site_groups (List[str]): A list of site group ids in this country
            which needs to be either restricted or allowed.  A list of values
            must be passed for either Sites or SiteGroups or both.  Max 10
            sites groups are allowed for the Shell site Restriction.
    ...
    def __init__(self,
        ...
        """Constructor for the LocationRestrictionsShellSiteRestrictionsItems class"""
