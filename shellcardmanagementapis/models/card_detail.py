...
from shellcardmanagementapis.models.card_delivery_contact import CardDeliveryContact
from shellcardmanagementapis.models.pin_delivery_contact import PINDeliveryContact
...
class CardDetail(object):
    ...
    Attributes:
        ...
        token_type_id (int): Token Type Id – Linked to the selected card
            type<br />  Optional<br />  Default – Assign the default token
            type associated with the card type of the card being created.<br
            />  The default value will be set by the background process and an
            error (code 12009) will be thrown by the background process when
            default value is not identified or invalid token type id is passed
            in the request.
        ...
        driver_name (str): Driver Name.<br />  Optional when VRN is passed
            else mandatory.<br />  Max length: 27<br />  The value will be
            validated against a configured list of allowed characters.<br /> 
        ...
        card_delivery_type (int): Card delivery type.<br />  Mandatory <br /> 
            ...
            Delivery Address
        card_contact (CardDeliveryContact): Request entity object for
            CardDeliveryContact  Mandatory when CardDeliveryType is 2 else
            ignored.
        ...
        pin_advice_type (int): PIN delivery method.<br />  Mandatory<br /> 
            ...
            selfselctedPIN type
        pin_contact (PINDeliveryContact): Request entity object for
            PINDeliveryContact  Mandatory when PINDeliveryAddressType is ‘3’
        ...
        usage_restriction_action (str): The value indicates what actions is to
            ...
            is passed. Else ignored.<br />  Allowed values: –<br />  •
            Update<br />  • Default<br />  • None
        ...
        products (List[str]): An array of 3-digit global product codes.<br /> 
            Optional.<br />  Default restrictions will be applied both
            products and product groups are null or empty.<br />  Note: This
            field is applicable when product restrictions are migrated to CFGW
    ...
    def from_dictionary(cls,
        ...
        card_contact = CardDeliveryContact.from_dictionary(dictionary.get('CardContact')) if 'CardContact' in dictionary.keys() else APIHelper.SKIP
        ...
        pin_contact = PINDeliveryContact.from_dictionary(dictionary.get('PINContact')) if 'PINContact' in dictionary.keys() else APIHelper.SKIP
