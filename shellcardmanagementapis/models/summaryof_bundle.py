...
class SummaryofBundle(object):

    """Implementation of the 'SummaryofBundle' model.
    ...
    Attributes:
        ...
        account_number (str): Account Number of the customer.   Either
            ...
            GB000000123
        bundle_id (List[str]): Identifier of the card bundle in Gateway. 
            Mandatory
    ...
    def __init__(self,
        ...
        """Constructor for the SummaryofBundle class"""
