...
from shellcardmanagementapis.models.card_details_response_card_delivery_address import CardDetailsResponseCardDeliveryAddress
...
from shellcardmanagementapis.models.card_details_response_pin_delivery_address import CardDetailsResponsePINDeliveryAddress
...
class CardDetailsResponse(object):
    ...
    Attributes:
        ...
        reissue_setting (CardDetailsResponseReissueSettingEnum): Reissue
            setting of the card. If the card is superseded (i.e. a
            replacement/new card is issued) then reissue setting of the latest
            card issued. Reissue setting:   * `True` - Card will be Reissued
            when nearing its expiry date   * `False` - Card will not be
            Reissued
        ...
        international_pos_language_code
            ...
            * `fil` - Filipino   * `est` - Estonian   * `lav` - Latvian   *
            `lit` - Lithuanian
        local_pos_language_id (CardDetailsResponseLocalPOSLanguageIDEnum): POS
            language identifier. Language Id:   * `1` - German   * `2` -
            French   * `3` - Bulgarian   * `4` - Croatian   * `5` - Czech   *
            `6` - Danish   * `7` - Finnish   * `8` - English   * `9` - Greek  
            * `10` - Chinese   * `11` - Hungarian   * `12` - Italian   * `13`
            - Luxembourgish   * `14` - Malay   * `15` - Dutch   * `16` -
            Norwegian, Bokmal   * `17` - Urdu   * `18` - Polish   * `19` -
            Portuguese   * `20` - Romanian   * `21` - Russian   * `22` -
            Slovak   * `23` - Slovenian   * `24` - Spanish   * `25` - Swedish 
            * `26` - Turkish   * `27` - Thai   * `28` - Filipino   * `29` -
            Estonian   * `30` - Latvian   * `31` - Lithuanian
        local_pos_language_code (CardDetailsResponseLocalPOSLanguageCodeEnum):
            POS language code. Language code:   * `deu` - German   * `fra` -
            French   * `bul` - Bulgarian   * `hrv` - Croatian   * `ces` -
            Czech   * `dan` - Danish   * `fin` - Finnish   * `eng` - English  
            * `ell` - Greek   * `zho` - Chinese   * `hun` - Hungarian   *
            `ita` - Italian   * `ltz` - Luxembourgish   * `msa` - Malay   *
        ...
        bundle_id (str): Bundle Id associated with card in the Gateway. This
            ...
            request is false.
        card_delivery_address (CardDetailsResponseCardDeliveryAddress):
            Delivery address.
        pin_delivery_address (CardDetailsResponsePINDeliveryAddress): Delivery
            address.
    ...
    def from_dictionary(cls,
        ...
        card_delivery_address = CardDetailsResponseCardDeliveryAddress.from_dictionary(dictionary.get('CardDeliveryAddress')) if 'CardDeliveryAddress' in dictionary.keys() else APIHelper.SKIP
        pin_delivery_address = CardDetailsResponsePINDeliveryAddress.from_dictionary(dictionary.get('PINDeliveryAddress')) if 'PINDeliveryAddress' in dictionary.keys() else APIHelper.SKIP
