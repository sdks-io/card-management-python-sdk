...
class SearchRequest(object):
    ...
    Attributes:
        ...
        card_status (List[str]): Status of the card.<br />  Mandatory.<br /> 
            ...
            status Temporary Blocked By Customer<br />  • TEMP_BLOCKED_SHELL
            or Temporary Block (Shell) – Cards at Status Temporary Blocked by
        ...
        sort_order (str): Possible options are:<br /> 
            ...
            be considered)<br />  4.DriverNameDescending(If Driver Name is
            null then VRN value will be considered)<br />  5.VRNAscending(If
            VRN is null then Driver Name value will be considered)<br /> 
