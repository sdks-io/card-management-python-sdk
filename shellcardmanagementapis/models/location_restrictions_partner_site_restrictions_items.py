...
class LocationRestrictionsPartnerSiteRestrictionsItems(object):

    """Implementation of the 'LocationRestrictionsPartnerSiteRestrictionsItems' model.
    ...
    def __init__(self,
        ...
        """Constructor for the LocationRestrictionsPartnerSiteRestrictionsItems class"""
    ...
    def from_dictionary(cls,
        ...
        network_code = dictionary.get("NetworkCode") if dictionary.get("NetworkCode") else None
