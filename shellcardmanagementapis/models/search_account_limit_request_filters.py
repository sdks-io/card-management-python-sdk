...
class SearchAccountLimitRequestFilters(object):

    """Implementation of the 'SearchAccountLimitRequestFilters' model.
    ...
    Attributes:
        ...
        account_id (int): Optional if AccountNumber is passed else Mandatory 
            Example: 123456
    ...
    def __init__(self,
        ...
        """Constructor for the SearchAccountLimitRequestFilters class"""
