...
from shellcardmanagementapis.models.summary_of_bundle_response_data_items import SummaryOfBundleResponseDataItems
...
class SummaryOfBundleResponse(object):
    ...
    Attributes:
        ...
        data (List[SummaryOfBundleResponseDataItems]): TODO: type description
            here.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [SummaryOfBundleResponseDataItems.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
